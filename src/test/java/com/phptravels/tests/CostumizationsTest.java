...
public class CostumizationsTest {
    ...
    public void desktopApptest() {
        ...
        dashboardPage.costumizations.click();

        Assert.assertEquals(Driver.getDriver().getTitle(),"Integrated suppliers API's XML Json - PHPTRAVELS");
